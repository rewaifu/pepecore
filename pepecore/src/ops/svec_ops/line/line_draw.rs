...
mod tests {
    ...
    fn test_create_u16_svec() {
        ...
        let line = vec![Line::Bezier(Point{x:0,y:100,size:1},Point{x:500,y:600,size:50},Point{x:200,y:900,size:5},Point{x:900,y:400,size:1},1.0/2000.0),Line::Bresenham(Point{x:1000,y:500,size:100},Point{x:900,y:600,size:10})];
