...
use pyo3::{pyclass, pyfunction, Bound, PyAny, PyResult, Python};
...
pub fn py_palette<'py>(py: Python<'py>, img: Bound<'py, PyAny>,num_ch:usize,alg:PyPaletteAlg) -> PyResult<Bound<'py, PyArray3<f32>>> {
